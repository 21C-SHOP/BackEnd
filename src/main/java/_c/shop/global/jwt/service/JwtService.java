...
import _c.shop.global.apiPayload.exception.TokenInvalidException;
import _c.shop.global.jwt.RefreshToken;
...
public class JwtService {
    ...
    public Optional<String> extractRefreshToken(final HttpServletRequest request) {
        ...
        return Arrays.stream(request.getCookies())
                ...
                .map(Optional::of)
                .orElseThrow(() -> new ExceptionHandler(ErrorStatus._REFRESHTOKEN_NOT_FOUND));
    }
     ...
     */
    public boolean isNotInRedis(final String refreshToken) {
     ...
     */
    private void sendAccessToken(final HttpServletResponse response, final String accessToken) {
        response.setStatus(HttpServletResponse.SC_OK);
     ...
     */
    private void sendRefreshToken(final HttpServletResponse response, final String refreshToken) {
